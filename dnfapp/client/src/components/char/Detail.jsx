        ...
        <div className='charEquips'>
          <div className='charImg'>
            ...
            <div className='charText'>
              <div>[서버]&nbsp;{serverName[charDetailDatas.serverId]}</div>
              <div>[모험단]&nbsp;{charDetailDatas.adventureName}</div>
              <div>[캐릭터]{charDetailDatas.characterName}</div>
              <div>[레벨]{charDetailDatas.level}</div>
              <div>[직업]{charDetailDatas.jobGrowName}</div>
              <div>[길드]&nbsp;{charDetailDatas.guildName}</div>
              {charDetailDatas.status.length > 0 ? <div>[명성]&nbsp;{charDetailDatas.status[16].value}</div> : ""}
            </div>
          </div>
